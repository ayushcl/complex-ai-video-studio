...
description: Turn a plan or task into a handoff package of self-contained prompts that multiple blank LLM agents can run in parallel without colliding. Use to fan work out across agents/chats, break a plan into parallel prompts, or delegate/split a task — instead of implementing it inline.
disable-model-invocation: true
---

Derived from canonical `_project-tracker/skills/parallel-task-handoff/SKILL.md` — do not edit directly; edit the canonical source and refresh.
